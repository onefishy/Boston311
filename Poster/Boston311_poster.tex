...
\vskip0.2cm
\textbf{Goal:} Compare effectiveness of response to constituent calls and Citizens Connect App by modeling the geographic and response time distribution with Gaussian mixture models.
  \begin{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{center}
    \includegraphics[width=0.78\textwidth, height=0.16\textheight]{graph_model}
    \end{center}
