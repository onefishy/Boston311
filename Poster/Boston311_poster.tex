...
Using the Bayes Information Criterion, we chose a model with $K=3$ components. 
 \vskip0.2cm
We compute both maximum likelihood estimates and maximum a posterior estimates for the component parameters through expectation maximization. We compared these point estimates to the results for simulated annealing. 
 \vskip0.2cm
