...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
We want to compare the patterns in 311 requests and responses originating from constituent calls and the new Citizens Connect App. 
  \begin{center}
  \includegraphics[width=0.48\textwidth, height=0.23\textheight]{Intensity_call}
  \includegraphics[width=0.48\textwidth, height=0.23\textheight]{Intensity_app}
  \end{center}
  }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
