...
\vskip0.2cm
\textbf{Goal:} compare the patterns in 311 requests and responses originating from constituent calls and the new Citizens Connect App. 
  \begin{center}
  ...
  \captionof{figure}{311 request volume intensity surface for constituent calls and Citizens Connect App (2015)}
  \end{center}
  }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \end{center}
    A basic generative model for our mixture can be specified by the following:
\begin{align}
\pi &\sim Dir(\alpha_0)\\
...
\end{align}
Note that the parameters of our model is 
\begin{align}
\theta = (\alpha_0, W_0, \nu_0, \eta_0, \beta_0).
\end{align} 
}
 ...
 \vskip0.2cm
  ...
  \begin{align*}
   ...
   \end{align*}
  \vskip0.2cm
Each point in the data, $\vx_n$, is a three dimensional vector with features: 
\begin{center}
...
We compute both the MLE and the MAP estimations for the parameters of the components through Expectation Maximization. Our EM algorithms are initialized with results from K-means and simulated annealing. 
 \vskip0.2cmThe point estimates to initialize a Gibbs sampler for the posterior distribution. These samples are then used to generate the posterior predictive distribution to compare to the original data.
   }
\end{poster}%
%
\end{document}
